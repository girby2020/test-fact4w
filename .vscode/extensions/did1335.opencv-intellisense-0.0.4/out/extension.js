...
function activate(context) {
    ...
    //subscription	
    context.subscriptions.push(disposable, comp.provider1, comp.provider2, comp.provider3, comp.provider4, comp.provider5, comp.provider6, comp.provider7, comp.provider8, comp.provider9, comp.provider10, comp.provider11, comp.provider12, comp.provider13, comp.provider14);
}
